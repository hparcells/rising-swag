...
const data: IItem[] = [
  {
    ...
    description:
      'Everyone needs a cozy go-to hoodie to curl up in, and our Howler hoodie is soft, smooth, and sporting the House Mars Wolf Sigil emblazoned on the chest. Available in both red and black.',
    link: 'https://www.lit-escalates.com/collections/apparel/products/howler-unisex-hoodie'
  },
  {
    date: '2023-03-13',
    image:
    ...
    description:
      'Everyone needs a cozy go-to hoodie to curl up in, and our Howler hoodie is soft, smooth, and sporting the House Mars Wolf Sigil emblazoned on the chest. Available in both red and black.',
    link: 'https://www.lit-escalates.com/collections/apparel/products/black-howler-unisex-hoodie'
  },
  {
    date: '2023-03-15',
  ...
  {
    date: '2023-05-03',
    image: 'https://i.etsystatic.com/38424619/r/il/67c6c3/4918632255/il_794xN.4918632255_nu2v.jpg',
    name: 'Howler Box Logo Hoodie',
    tags: ['hoodie'],
    shop: {
      name: 'FunnyBoxLogo',
      url: 'https://www.etsy.com/shop/FunnyBoxLogo'
  ...
  {
    date: '2023-11-24',
    image: 'https://howlerholo.net/wp-content/uploads/2023/11/32920-600x600.jpg',
    name: 'Thunder & Lightning Unisex Hoodie',
    tags: ['hoodie', 'darrow', 'cassius', 'red-rising'],
    shop: {
      name: "The Howler's Den",
